...
public class AppliedLeaves extends AppCompatActivity implements Serializable {
    ...
    String internalExamUrl = "StaffAttendanceService.svc/GetLeavesApplied?FromDate=01 May 2016&ToDate=30 May 2016";
    String loginURL = "";
    Context ctx;
    int currentMonth = 0;
    Date initDate;
    ...
    private void moveToLanding() {
        Intent i = new Intent(AppliedLeaves.this, Home.class);
        startActivity(i);
        finish();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View.OnClickListener onFilterOkclickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (popupMessage.isShowing()) {
                    ...
                    Toast.makeText(AppliedLeaves.this, "From date cant exceed to date", Toast.LENGTH_SHORT).show();
                }
        ...
        calendarView.setCalendarListener(new CalendarListener() {
            ...
            public void onMonthChanged(Date d) {
                if (!isNetworkAvailable()){
                    calendarView.refreshCalendar(showingCalander);
                    Toast.makeText(AppliedLeaves.this, "Network not available.", Toast.LENGTH_SHORT).show();
                } else {
                    Calendar cal = Calendar.getInstance();
                    cal.setTime(d);
    ...
    private void setTheInternalExamScreen(String result) {
        ...
        try {
            ...
            if(dataList.length() == 0) {
                Toast.makeText(AppliedLeaves.this, "No. Tasks in given Date range", Toast.LENGTH_SHORT).show();
...
//            Toast.makeText(InternalExams.this, "No Tasks in given Date range", Toast.LENGTH_SHORT).show();
    ...
    private void makeNetworkCall(){
        // Make network call
        if (isNetworkAvailable()) {
            String url = credentialManager.getUniversityUrl() + "/StaffAttendanceService.svc/GetLeavesApplied?FromDate="
            ...
            progressBarHolder.setVisibility(View.VISIBLE);
            new AppliedLeavesTask().execute(loginURL, url);
            setPickers();
            setTheTasks(fromDatePicker, toDatePicker, -1);
        } else {
            Toast.makeText(AppliedLeaves.this, "Network not available.", Toast.LENGTH_SHORT).show();
        ...
        public void useLoginToken(String result){
            try {
                ...
                if(resultJSON.getInt("ServiceResult") == 0) {
                    ...
                    i = new Intent(AppliedLeaves.this, LoginActivity.class);
